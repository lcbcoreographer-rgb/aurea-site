...
const TESTIMONIALS: { name: string; role: string; text: string; photo?: string }[] = [
  ...
  { name: "Silva", role: "CEO — KDB Imports", text: "Slk, um cliente meu tinha gastado mais de 9k em 3 meses com outro gestor de tráfego e não vendeu nada. Com 5 dias de Áurea Group ele já vendeu mais do que com o gestor antigo. Boraaaaaa!", photo: "/testimonials/silva.jpg" },
  ...
  { name: "Silva", role: "CEO — Koda Box", text: "Cara, imagina investir 60 reais por dia e voltar R$3.627. Foi isso que aconteceu com um cliente meu depois que a Áurea Group assumiu o tráfego — ROAS de 54,13, surreal.", photo: "/testimonials/silva.jpg" },
];
