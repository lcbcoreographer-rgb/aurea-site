...
const TESTIMONIALS: { name: string; role: string; text: string; photo?: string }[] = [
  ...
  { name: "Silva", role: "CEO — KDB Imports", text: "Foi isso que a Áurea fez com as vendas do meu e-commerce. Eu tinha gastado mais de 9k em 3 meses com outro gestor de tráfego sem resultado nenhum. Com 5 dias de Áurea Group já vendi mais do que com o gestor antigo. Boraaaaaa!", photo: "/testimonials/silva.jpg" },
  { name: "Ramon Henrique", role: "CEO — Ramon Bikes e Acessórios", text: "Antes a gente tinha umas 500 mensagens por mês. Investindo o mesmo valor de sempre, hoje com a Áurea Group as conversas praticamente dobraram e o custo por conversa só vem caindo. Surreal.", photo: "/testimonials/ramon-henrique.jpg" },
  { name: "Marcelo Gomes", role: "CEO — 3TECH", text: "Eu nunca tinha tido resultado terceirizando o tráfego, sempre preferi fazer eu mesmo. Até conhecer a Áurea Group: em menos de 30 dias já foram 137 vendas e R$4.132,80 em conversão. Não esperava um resultado desses.", photo: "/testimonials/marcelo-gomes.jpg" },
  { name: "Silva", role: "CEO — Koda Box", text: "Cara, imagina investir 60 reais por dia e voltar R$3.627. Foi isso que aconteceu na minha loja depois que a Áurea Group assumiu o tráfego. ROAS de 54,13.", photo: "/testimonials/silva.jpg" },
];
  ...
  return (
    <>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(0,0,0,.75)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(255,255,255,.06)" }} className="nav-wrap">
        ...
        <a href="/forms" className="btn-primary hide-mobile" style={{ fontSize: 13, padding: "10px 20px", whiteSpace: "nowrap" }}>Falar com especialista →</a>
      ...
      <section className="hero-wrap" style={{ paddingTop: 160, paddingBottom: 100, textAlign: "center", position: "relative", zIndex: 1 }}>
        <div className="hero-section" style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div className="fade-up d3" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="/forms" className="btn-primary">Quero uma proposta gratuita →</a>
